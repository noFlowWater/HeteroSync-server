...
func (r *SQLiteRepository) SaveTimeSyncRecord(record *models.TimeSyncRecord) error {
	...
	INSERT INTO time_sync_records (
		device1_id, device1_type,
		device2_id, device2_type,
		device1_t1, device1_t2, device1_t3, device1_t4,
		device2_t1, device2_t2, device2_t3, device2_t4,
		device1_offset, device1_delay, device1_rtt,
		device2_offset, device2_delay, device2_rtt,
		time_difference,
	...
	result, err := r.db.Exec(query,
		...
		record.Device2T3,
		record.Device2T4,
		record.Device1Offset,
		record.Device1Delay,
		record.Device1RTT,
		record.Device2Offset,
		record.Device2Delay,
		record.Device2RTT,
...
func (r *SQLiteRepository) GetTimeSyncRecord(id int64) (*models.TimeSyncRecord, error) {
	query := `
	SELECT id, device1_id, device1_type, device2_id, device2_type,
	       device1_t1, device1_t2, device1_t3, device1_t4,
	       device2_t1, device2_t2, device2_t3, device2_t4,
	       device1_offset, device1_delay, device1_rtt,
	       device2_offset, device2_delay, device2_rtt,
	       time_difference, status, error_message, created_at
...
func (r *SQLiteRepository) getAggregationMeasurements(aggregationID string) ([]*models.TimeSyncRecord, error) {
	query := `
	SELECT t.id, t.device1_id, t.device1_type, t.device2_id, t.device2_type,
	       t.device1_t1, t.device1_t2, t.device1_t3, t.device1_t4,
	       t.device2_t1, t.device2_t2, t.device2_t3, t.device2_t4,
	       t.device1_offset, t.device1_delay, t.device1_rtt,
	       t.device2_offset, t.device2_delay, t.device2_rtt,
	       t.time_difference, t.status, t.error_message, t.created_at
